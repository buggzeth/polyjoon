...
export const POLYGON_RPC = "https://polygon-rpc.com"; // Standard RPC
...
export const TREASURY_ADDRESS = "0x3233f590f3cb6A70123bD02B49105Be5d5C10DF3"; // Replace with your wallet address
export const USDC_DECIMALS = 6;
export const ANALYSIS_COST_USDC = 0.5;